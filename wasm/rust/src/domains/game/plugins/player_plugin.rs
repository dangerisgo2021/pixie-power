use crate::domains::game::domain_objects::player::{Player, SnakeNode, Tail};
...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(FixedUpdate, move_player.chain());
    }
}

fn move_player(
    mut player_query: Query<(&mut Player, &mut Transform, Entity), With<Player>>,
    ...
    let (mut player, mut player_transform, player_entity) = player_query.single_mut();
